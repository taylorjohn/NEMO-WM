...
sess     = ort.InferenceSession('./npu_models/cortex_student_fp32.onnx', providers=['CPUExecutionProvider'])
...
print('Cosine similarity (PT vs FP32 ONNX):', round(cosine,6))
print('MAE                                 :', round(mae,8))
print('Status: OK' if cosine > 0.9999 else 'WARNING')
