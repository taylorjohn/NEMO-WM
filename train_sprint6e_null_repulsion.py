"""
train_sprint6e_null_repulsion.py — Sprint 6e: Hard Null Rejection
==================================================================
...
Sprint 6e changes vs 6d:
  1. null_weight: 0.5 → 5.0  (10× increase — forces L_null to compete with L_clip)
  2. Hard negatives: navigation-adjacent texts that share visual vocabulary
     but are not navigation commands. These are the truly hard cases —
     texts the model might legitimately confuse with navigation.
  3. Start from Sprint 6c checkpoint (better alignment baseline than 6d)
  4. 3 epochs only — minimal intervention
...
NULL_TEXTS = [
    # Generic nulls — keep the originals
    "a recipe for chocolate cake",
    "sonnets by shakespeare",
    "the quick brown fox jumps over the lazy dog",
    # Navigation-adjacent hard negatives — new for Sprint 6e
    "a car drives down the highway at high speed",
    "weather forecast showing wind and temperature",
    "satellite map view of urban streets",
    "a person walking through a shopping mall",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Sprint 6e — Hard Null Rejection")
    ...
    parser.add_argument("--save-path",    default="checkpoints/dinov2_student/student_dualhead_6e_best.pt")
