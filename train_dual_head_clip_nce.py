...
def train(
    ...
    save_path:    str   = r"checkpoints\dinov2_student\student_dualhead_nce_best.pt",
):
    print("\nSprint 6c — Dual-Head InfoNCE CLIP Distillation")
    print("=" * 50)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-path",
                        default=r"checkpoints\dinov2_student\student_dualhead_nce_best.pt")
